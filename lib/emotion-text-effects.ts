...
export const EMOTION_TEXT_PRESETS: EmotionTextStyle[] = [
  ...
  // ========== 🏆 赞美夸赞系列 ==========
  {
    id: 'praise-bangbangda',
    name: '👏 棒棒哒',
    emotion: 'happy',
    description: '可爱活泼的夸奖，彩虹糖果风',
    layout: {
      randomRotation: { min: -12, max: 12 },
      randomOffset: { x: 5, y: 6 },
      randomScale: { min: 0.9, max: 1.15 },
    ...
    text: {
      ...
      fontSize: 68,
      color: '#FFFFFF',
      gradient: 'linear-gradient(135deg, #FF6B9D 0%, #FFB347 25%, #FFED47 50%, #47D147 75%, #47C7FF 100%)',
      stroke: { color: '#FFFFFF', width: 3 },
      shadow: '0 0 30px rgba(255,107,157,0.6), 4px 4px 0 rgba(0,0,0,0.2)',
    },
    decoration: {
      type: 'sparkle',
      items: ['👏', '✨', '🌟', '💖', '🎀', '🌈', '⭐'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 80,
      color: '#FFD700',
      gradient: 'linear-gradient(180deg, #FFFDE7 0%, #FFD700 25%, #FFA000 55%, #FF6F00 85%, #E65100 100%)',
      stroke: { color: '#5D4037', width: 6 },
      shadow: '0 0 50px #FFD700, 0 0 100px rgba(255,215,0,0.8), 6px 6px 0 #3E2723, 0 0 150px #FFD700',
    },
    decoration: {
      type: 'sparkle',
      items: ['🌟', '⭐', '✨', '💫', '🏆', '👑', '🎉'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 90,
      color: '#FFFFFF',
      gradient: 'linear-gradient(180deg, #FFFFFF 0%, #FFEB3B 15%, #FF9800 35%, #FF5722 60%, #D32F2F 85%, #B71C1C 100%)',
      stroke: { color: '#000000', width: 8 },
      shadow: '0 0 60px #FF5722, 0 0 120px rgba(255,87,34,0.8), 8px 8px 0 #000, -4px -4px 0 #FF5722, 0 0 200px rgba(255,87,34,0.5)',
    },
    decoration: {
      type: 'particle',
      items: ['🔥', '💪', '🤟', '⚡', '💥', '🏆', '😎'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 76,
      color: '#FFFFFF',
      gradient: 'linear-gradient(180deg, #FFFFFF 0%, #FF6D00 30%, #FF3D00 60%, #DD2C00 100%)',
      stroke: { color: '#000000', width: 6 },
      shadow: '0 0 45px #FF6D00, 6px 6px 0 #000, 0 0 90px rgba(255,109,0,0.6)',
    },
    decoration: {
      type: 'particle',
      items: ['💪', '👍', '🤙', '⚡', '🔥', '✨'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 74,
      color: '#FFFFFF',
      gradient: 'linear-gradient(135deg, #E1BEE7 0%, #CE93D8 20%, #AB47BC 45%, #8E24AA 70%, #6A1B9A 100%)',
      stroke: { color: '#FFFFFF', width: 3 },
      shadow: '0 0 40px #AB47BC, 0 0 80px rgba(171,71,188,0.6), 4px 4px 0 rgba(0,0,0,0.3)',
    },
    decoration: {
      type: 'sparkle',
      items: ['🤩', '✨', '💫', '💜', '🦋', '💎', '⭐'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 82,
      color: '#FFFFFF',
      gradient: 'linear-gradient(180deg, #ECEFF1 0%, #90A4AE 30%, #546E7A 60%, #37474F 100%)',
      stroke: { color: '#000000', width: 6 },
      shadow: '0 0 30px #546E7A, 6px 6px 0 #000, 0 0 60px rgba(84,110,122,0.5)',
    },
    decoration: {
      type: 'particle',
      items: ['👊', '😎', '🥶', '❄️', '💀', '⚡'],
  ...
  // ========== 😱 震惊反应系列 ==========
  {
    ...
    name: '😱 卧槽',
    emotion: 'surprised',
    description: '极度震惊，下巴掉地',
    layout: {
      randomRotation: { min: -18, max: 18 },
      randomOffset: { x: 10, y: 10 },
      randomScale: { min: 0.85, max: 1.25 },
      stagger: true,
      staggerDelay: 20,
    },
    text: {
      ...
      shadow: '0 0 50px #9C27B0, 7px 7px 0 #000, 0 0 100px rgba(156,39,176,0.7), -4px -4px 0 #E1BEE7',
    },
    decoration: {
      type: 'emoji',
      items: ['😱', '🤯', '❗', '❕', '😵', '💥', '⁉️'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 72,
      color: '#FFFFFF',
      gradient: 'linear-gradient(180deg, #E3F2FD 0%, #64B5F6 30%, #1976D2 60%, #0D47A1 100%)',
      stroke: { color: '#FFFFFF', width: 4 },
      shadow: '0 0 40px #1976D2, 4px 4px 0 rgba(0,0,0,0.4), 0 0 80px rgba(25,118,210,0.5)',
    },
    decoration: {
      type: 'emoji',
      items: ['😲', '😮', '🌟', '✨', '❗', '💫'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 66,
      color: '#F9A825',
      gradient: 'linear-gradient(180deg, #FFF8E1 0%, #FFCA28 35%, #F9A825 65%, #F57F17 100%)',
      stroke: { color: '#FFFFFF', width: 3 },
      shadow: '3px 3px 0 #FFFFFF, 6px 6px 0 rgba(0,0,0,0.3), 0 0 30px rgba(249,168,37,0.5)',
    },
    decoration: {
      type: 'emoji',
      items: ['❓', '❔', '🤔', '😕', '🧐', '⁉️'],
  ...
  },
  {
    ...
    text: {
      ...
      color: '#FFB300',
      stroke: { color: '#FFFFFF', width: 3 },
      shadow: '3px 3px 0 #FFFFFF, 0 0 25px rgba(255,179,0,0.5)',
    },
    decoration: {
      type: 'emoji',
      items: ['🤨', '❓', '🧐', '🤔', '😏'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 80,
      color: '#FFFFFF',
      gradient: 'linear-gradient(180deg, #FFFFFF 0%, #FF5252 30%, #D50000 70%, #B71C1C 100%)',
      stroke: { color: '#000000', width: 6 },
      shadow: '0 0 40px #FF5252, 6px 6px 0 #000, 0 0 80px rgba(255,82,82,0.6)',
    },
    decoration: {
      type: 'emoji',
      items: ['❗', '❕', '⁉️', '😱', '🤯', '💢'],
  ...
  // ========== 💖 可爱萌系列 ==========
  {
    ...
    text: {
      ...
      fontSize: 64,
      color: '#FF80AB',
      gradient: 'linear-gradient(135deg, #FFEBEE 0%, #FF80AB 30%, #F48FB1 50%, #F06292 75%, #EC407A 100%)',
      stroke: { color: '#FFFFFF', width: 3 },
      shadow: '0 0 35px #FF80AB, 3px 3px 0 #FFFFFF, 0 0 70px rgba(255,128,171,0.5)',
    },
    decoration: {
      type: 'sparkle',
      items: ['🥰', '💖', '💕', '✨', '🎀', '🌸', '💗'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 62,
      color: '#FFB74D',
      gradient: 'linear-gradient(135deg, #FFF3E0 0%, #FFB74D 35%, #FFA726 65%, #FF9800 100%)',
      stroke: { color: '#FFFFFF', width: 3 },
      shadow: '3px 3px 0 #FFFFFF, 6px 6px 0 #F57C00, 0 0 30px rgba(255,183,77,0.5)',
    },
    decoration: {
      type: 'emoji',
      items: ['😻', '🐱', '💕', '✨', '🎀', '🌟', '💖'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 60,
      color: '#F48FB1',
      gradient: 'linear-gradient(135deg, #FFEEFF 0%, #F8BBD9 25%, #F48FB1 50%, #F06292 75%, #EC407A 100%)',
      stroke: { color: '#FFFFFF', width: 3 },
      shadow: '0 0 30px #F48FB1, 3px 3px 0 #FFFFFF, 0 0 60px rgba(244,143,177,0.5)',
    },
    decoration: {
      type: 'sparkle',
      items: ['🍬', '🍭', '🧁', '🍰', '💕', '✨', '💖'],
  ...
  },
  {
    ...
    name: '❤️ 爱你',
    emotion: 'love',
    description: '满满的爱，心形爆炸',
    layout: {
      randomRotation: { min: -6, max: 6 },
      randomOffset: { x: 3, y: 3 },
      randomScale: { min: 0.96, max: 1.1 },
      stagger: true,
      staggerDelay: 45,
    },
    text: {
      ...
      fontSize: 70,
      color: '#E91E63',
      gradient: 'linear-gradient(135deg, #FFEBEE 0%, #FF80AB 20%, #F06292 45%, #E91E63 70%, #C2185B 100%)',
      stroke: { color: '#FFFFFF', width: 4 },
      shadow: '0 0 45px #E91E63, 4px 4px 0 rgba(255,255,255,0.8), 0 0 90px rgba(233,30,99,0.5)',
    },
    decoration: {
      type: 'emoji',
      items: ['❤️', '💕', '💖', '💗', '💓', '💘', '🥰', '😍'],
    ...
    animation: {
      enter: 'heart-burst-in',
      loop: 'heartbeat-strong',
      duration: 450,
    },
  },
  ...
  // ========== 😂 搞笑爆笑系列 ==========
  {
    ...
    name: '🤣 笑死我了',
    emotion: 'funny',
    description: '笑到抽搐，停不下来',
    layout: {
      randomRotation: { min: -25, max: 25 },
      randomOffset: { x: 10, y: 12 },
      randomScale: { min: 0.8, max: 1.25 },
      stagger: true,
      staggerDelay: 35,
    },
    text: {
      ...
      fontSize: 66,
      color: '#FFD93D',
      gradient: 'linear-gradient(135deg, #FFFDE7 0%, #FFD93D 30%, #FFC107 60%, #FF9800 100%)',
      stroke: { color: '#FF6B6B', width: 4 },
      shadow: '4px 4px 0 #FF6B6B, 8px 8px 0 rgba(0,0,0,0.25), 0 0 35px rgba(255,217,61,0.6)',
    },
    decoration: {
      type: 'emoji',
      items: ['🤣', '😂', '😹', '🤪', '😆', '💀', '😭'],
    ...
    animation: {
      enter: 'laugh-shake-in',
      loop: 'laugh-tremor',
      duration: 380,
    },
  },
  {
    id: 'funny-bengbuzhule',
    name: '😂 绷不住了',
    emotion: 'funny',
    description: '忍不住，彻底崩溃',
    layout: {
      randomRotation: { min: -20, max: 20 },
      randomOffset: { x: 8, y: 10 },
      randomScale: { min: 0.85, max: 1.2 },
    ...
    text: {
      ...
      color: '#FF9F43',
      stroke: { color: '#FFFFFF', width: 3 },
      shadow: '3px 3px 0 #FFFFFF, 6px 6px 0 #E17055, 0 0 30px rgba(255,159,67,0.5)',
    },
    decoration: {
      type: 'emoji',
      items: ['😂', '🤣', '😹', '🙈', '🤭', '💧'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 60,
      color: '#FFFFFF',
      gradient: 'linear-gradient(135deg, #E0E0E0 0%, #9E9E9E 40%, #616161 70%, #424242 100%)',
      stroke: { color: '#212121', width: 4 },
      shadow: '4px 4px 0 #212121, 0 0 25px rgba(158,158,158,0.4)',
    },
    decoration: {
      type: 'emoji',
      items: ['💀', '☠️', '🎭', '🃏', '👻', '🤡'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 56,
      color: '#78909C',
      shadow: '0 0 20px rgba(120,144,156,0.4)',
    },
    decoration: {
      type: 'emoji',
      items: ['😫', '😩', '💤', '🥱', '😮‍💨', '🫠'],
  ...
  // ========== 🔥 超燃系列 ==========
  {
    ...
    text: {
      ...
      fontSize: 86,
      color: '#FFFFFF',
      gradient: 'linear-gradient(180deg, #FFFFFF 0%, #FFFF00 15%, #FF9800 35%, #FF5722 55%, #F44336 75%, #B71C1C 100%)',
      stroke: { color: '#000000', width: 8 },
      shadow: '0 0 70px #FF5722, 0 0 140px rgba(255,87,34,0.7), 8px 8px 0 #000, 0 0 200px rgba(244,67,54,0.5)',
    },
    decoration: {
      type: 'particle',
      items: ['🔥', '⚡', '💥', '🌋', '☄️', '💪'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 84,
      color: '#FFD700',
      gradient: 'linear-gradient(180deg, #FFFDE7 0%, #FFD700 20%, #FFC107 45%, #FF9800 70%, #E65100 100%)',
      stroke: { color: '#5D4037', width: 7 },
      shadow: '0 0 60px #FFD700, 0 0 120px rgba(255,215,0,0.7), 7px 7px 0 #3E2723, 0 0 180px #FFD700',
    },
    decoration: {
      type: 'sparkle',
      items: ['👑', '🏆', '⭐', '💎', '✨', '🌟'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 80,
      color: '#FFFFFF',
      gradient: 'linear-gradient(180deg, #FFFFFF 0%, #FFEB3B 20%, #FFC107 45%, #FF9800 70%, #FF5722 100%)',
      stroke: { color: '#000000', width: 7 },
      shadow: '0 0 55px #FFC107, 0 0 110px rgba(255,193,7,0.6), 7px 7px 0 #000',
    },
    decoration: {
      type: 'particle',
      items: ['⚡', '🔥', '💥', '✨', '🚀', '💫'],
  ...
  // ========== 😢 扎心系列 ==========
  {
    ...
    name: '💔 扎心了',
    emotion: 'sad',
    description: '心碎一地，扎心老铁',
    layout: {
      randomRotation: { min: -6, max: 6 },
      randomOffset: { x: 3, y: 4 },
      randomScale: { min: 0.94, max: 1.06 },
      stagger: true,
      staggerDelay: 70,
    },
    text: {
      ...
      fontSize: 60,
      color: '#E57373',
      gradient: 'linear-gradient(180deg, #FFCDD2 0%, #EF9A9A 30%, #E57373 60%, #EF5350 100%)',
      shadow: '0 0 30px rgba(229,115,115,0.5), 3px 3px 0 #FFFFFF',
    },
    decoration: {
      type: 'emoji',
      items: ['💔', '😢', '😭', '🥺', '💧', '😿'],
  ...
  },
  {
    ...
    name: '😞 难了',
    emotion: 'sad',
    description: '太难了，人间不值得',
    layout: {
      randomRotation: { min: -5, max: 5 },
      randomOffset: { x: 2, y: 4 },
      randomScale: { min: 0.95, max: 1.03 },
      stagger: true,
      staggerDelay: 80,
    },
    text: {
      ...
      fontSize: 54,
      color: '#90A4AE',
      shadow: '0 0 20px rgba(144,164,174,0.4)',
    },
    decoration: {
      type: 'emoji',
      items: ['😞', '😔', '🥲', '😮‍💨', '💭', '🌧️'],
  ...
  // ========== 😤 吐槽系列 ==========
  {
    ...
    text: {
      ...
      color: '#78909C',
      stroke: { color: '#FFFFFF', width: 2 },
      shadow: '2px 2px 0 #FFFFFF, 0 0 20px rgba(120,144,156,0.4)',
    },
    decoration: {
      type: 'emoji',
      items: ['🙄', '😑', '😤', '🤷', '💢', '...'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 58,
      color: '#90A4AE',
      stroke: { color: '#455A64', width: 3 },
      shadow: '3px 3px 0 #455A64',
    },
    decoration: {
      type: 'emoji',
      items: ['📉', '😐', '😒', '🚪', '👋', '😮‍💨'],
  ...
  },
  {
    ...
    text: {
      ...
      fontSize: 62,
      color: '#7986CB',
      gradient: 'linear-gradient(180deg, #C5CAE9 0%, #9FA8DA 35%, #7986CB 65%, #5C6BC0 100%)',
      shadow: '0 0 30px rgba(121,134,203,0.5), 3px 3px 0 #FFFFFF',
    },
    decoration: {
      type: 'emoji',
      items: ['😶', '🥲', '😢', '💔', '🫠', '😭'],
    ...
    animation: {
      enter: 'crack-break-in',
      loop: 'vulnerable-shake',
      duration: 550,
    },
  },
