...
export const DECORATION_EFFECTS: DecorationEffect[] = [
  ...
  },
  {
    id: 'stroke-shadow',
    name: '描边投影',
    description: '经典描边+阴影，清晰易读',
    preview: '📝',
    textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000, 3px 3px 6px rgba(0,0,0,0.5)',
    hasStroke: true,
  },
  {
    id: 'soft-glow',
  ...
  },
  {
    ...
    preview: '💥',
    textShadow: '2px 2px 0 #000, 4px 4px 0 #ff0, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000',
    hasStroke: true,
  },
]
